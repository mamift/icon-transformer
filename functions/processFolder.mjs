...
import flattenXlinks from "./flattenXlinks";
          ...
          async fileName =>
            new Promise((resolve, reject) => {
              ...
              if (
                ...
                // FIXME: Total processed number is based on number of Promises returned, but this returns one Promise for potentially many files.
